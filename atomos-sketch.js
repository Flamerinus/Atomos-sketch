...
function setup() {
	...
	angleMode(DEGREES);
	//This just triggers the act() function in the same way pressing the Hidrogen button would.This is done so that the canvas displays something before any button gets clicked, and it doesn't appear empty.
	atomo.act(1);
}
